...
function CreateTableFromJSON(jsonData) {
  ...
  for (var i = 0; i < resultRowHeaders.length; i++) {
    ...
    tr.insertCell(-1).innerHTML = resultRowHeaders[i]; // tr.insertCell(-1).innerHTML = "Your " + resultRowHeaders[i] + " " + "is " + jsonData.clientURLResult[resultRowKeys[i]];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/output.js"], null)
//# sourceMappingURL=/output.9499a074.js.map