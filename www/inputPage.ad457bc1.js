...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"pages/input.js":[function(require,module,exports) {
document.getElementById("compare").addEventListener("click", function (evt) {
  ...
  var sURL = "/compare/?clientURL=" + sClientURL + "&keyword=" + sKeyword + "&location=" + sLocation + "&operation=" + sOperation + "&competitor1URL=" + sCompetitor1URL + "&competitor2URL=" + sCompetitor2URL + "&competitor3URL=" + sCompetitor3URL;
  fetch(sURL).then(function (response) {
    ...
    location.href = "./freeResult.html"; // var jsonResult = JSON.parse(data);
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","pages/input.js"], null)
//# sourceMappingURL=/inputPage.ad457bc1.js.map